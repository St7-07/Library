                                        ...
                                        <div className='h_btm'>
                                            ...
                                            <div className='cssmenu'>
                                                <ul>
                                                    ...
                                                    <li><a onClick={() => this.props.onClick("Solicitantes")}><span>Solicitantes</span></a></li>
                                                    <li><a onClick={() => this.props.onClick("Audiovisuales")}><span>Audiovisuales</span></a></li>
                                        ...
                                        <div className='h_btm'>
                                            ...
                                            <div className='cssmenu'>
                                                <ul>
                                                    ...
                                                    <li className="active"><a onClick={() => this.props.onClick("Solicitantes")}><span>Solicitantes</span></a></li>
                                                    <li><a onClick={() => this.props.onClick("Audiovisuales")}><span>Audiovisuales</span></a></li>
                                                    <li><a onClick={() => this.props.onClick("Historial")}><span>Historial</span></a></li>
                                                    <li><a onClick={() => this.props.onClick("Estadisticas")}><span>Estadisticas</span></a></li>
                                                </ul>
                                        ...
                                        <div className='h_btm'>
                                            ...
                                            <div className='cssmenu'>
                                                <ul>
                                                    <li><a onClick={() => this.props.onClick("Prestamos")}><span>Prestamos</span></a></li>
                                                    <li><a onClick={() => this.props.onClick("Solicitantes")}><span>Solicitantes</span></a></li>
                                                    <li className="active"><a onClick={() => this.props.onClick("Audiovisuales")}><span>Audiovisuales</span></a></li>
                                                    <li><a onClick={() => this.props.onClick("Historial")}><span>Historial</span></a></li>
                                                    <li><a onClick={() => this.props.onClick("Estadisticas")}><span>Estadisticas</span></a></li>
                                                </ul>
                                            </div>
